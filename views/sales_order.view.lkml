view: sales_order {
  sql_table_name: `m2_costway_uk.sales_order`
    ;;
  ...
  dimension: adyen_notification_event_code {
    type: string
    sql: ${TABLE}.adyen_notification_event_code ;;
  }

  dimension: adyen_notification_event_code_success {
    type: number
    sql: ${TABLE}.adyen_notification_event_code_success ;;
  }

  dimension: adyen_resulturl_event_code {
    type: string
    sql: ${TABLE}.adyen_resulturl_event_code ;;
  }
  ...
  dimension: aw_reward_points_blnce_refund {
    type: number
    sql: ${TABLE}.aw_reward_points_blnce_refund ;;
  }
  ...
  dimension: aw_reward_points_refund {
    type: number
    sql: ${TABLE}.aw_reward_points_refund ;;
  }
  ...
  dimension: base_aw_reward_points_refund {
    type: number
    sql: ${TABLE}.base_aw_reward_points_refund ;;
  }
  ...
  dimension: riskified_cart_token {
    type: string
    sql: ${TABLE}.riskified_cart_token ;;
  }
